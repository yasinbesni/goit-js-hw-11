import{S as d,i as c}from"./assets/vendor-CTPPT4__.js";(function(){const o=document.createElement("link").relList;if(o&&o.supports&&o.supports("modulepreload"))return;for(const t of document.querySelectorAll('link[rel="modulepreload"]'))i(t);new MutationObserver(t=>{for(const e of t)if(e.type==="childList")for(const r of e.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&i(r)}).observe(document,{childList:!0,subtree:!0});function n(t){const e={};return t.integrity&&(e.integrity=t.integrity),t.referrerPolicy&&(e.referrerPolicy=t.referrerPolicy),t.crossOrigin==="use-credentials"?e.credentials="include":t.crossOrigin==="anonymous"?e.credentials="omit":e.credentials="same-origin",e}function i(t){if(t.ep)return;t.ep=!0;const e=n(t);fetch(t.href,e)}})();window.global||(window.global=window);const u=new d(".gallery a",{captionsData:"alt",captionDelay:250}),p=document.querySelector(".search-button");p.addEventListener("click",a=>{a.preventDefault();const o=document.querySelector("#searchInput").value,n=document.querySelector(".loader"),i="51231879-eed04209a1a79d06c7f1b2879",t=new URLSearchParams({q:o,image_type:"photo",orientation:"horizontal",safesearch:"true"});t.q=o,n.style.display="flex",fetch(`https://pixabay.com/api/?key=${i}&${t.toString()}`).then(e=>{if(!e.ok)throw new Error("Network response was not ok "+e.statusText);return e.json()}).then(e=>{n.style.display="none";const r=document.querySelector(".gallery");r.innerHTML="";const l=e.hits.map(s=>`
